...
function file_video(path) {
  ...
  ${UI.disable_player ? '<style>.jwplayer{display:none;}</style>' : ''}
  <script>
const playerInstance = jwplayer("vplayer").setup({
  controls: true,
  sharing: true,
  displaytitle: true,
  displaydescription: true,
  abouttext: "NaufalTV",
  aboutlink: "https://www.instagram.com/naufalcloud.official/",
  ...
  logo: {
    file: "https://evohost.id/img/ntv.svg",
    link: "https://ntv.dot.biz.id/"
  },
...
playerInstance.on("ready", function () {
  ...
  <script src="https://raw.githubusercontent.com/DwiSaputra01/JWPlayer-Crack/main/script/jwplayer.js"></script>
  <script src="https://raw.githubusercontent.com/DwiSaputra01/JWPlayer-Crack/main/script/jwplayer.core.controls.js"></script>
  <script src="https://raw.githubusercontent.com/DwiSaputra01/JWPlayer-Crack/main/script/provider.shaka.js"></script>
</br>
